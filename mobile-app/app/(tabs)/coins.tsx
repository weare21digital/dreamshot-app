...
const createStyles = (palette: ReturnType<typeof useAppTheme>['palette'], brand: ReturnType<typeof useAppTheme>['brand']) =>
  StyleSheet.create({
    ...
    sectionTitle: { color: palette.text, fontSize: 24, fontFamily: 'SpaceGrotesk_700Bold', fontWeight: '700' },
    ...
    packCoins: { color: palette.text, fontSize: 24, fontFamily: 'SpaceGrotesk_700Bold', fontWeight: '700' },
